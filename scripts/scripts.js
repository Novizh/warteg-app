...
for (let i = 0; i < items.length; i++) {
  addItems(`#${items[i].name}-item`, `#${items[i].name}-button`,  `#harga-${items[i].name}`)
}
...
// for (let i=0; i<items.length; items++){
//   addItems(`#${items[i].name}-item`, `#${items[i].name}-button`, `#harga-${items[i].name}`, "#cart")
// }



// addItems('#telor-dadar-item', '#telor-dadar-button', '#harga-telor-dadar', '#cart')
// addItems('#kikil-item', '#kikil-button','#harga-kikil', '#cart')
// addItems('#capcay-item', '#capcay-button','#harga-capcay' ,'#cart')
// addItems('#mie-goreng-item', '#mie-goreng-button','#harga-mie-goreng', '#cart')